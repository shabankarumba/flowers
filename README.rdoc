...
3. "bundle exec rspec" to run the test suite
4 "rake xml_import" to import the XML data onto to the site
5. Finally type "rails server" to start the application
